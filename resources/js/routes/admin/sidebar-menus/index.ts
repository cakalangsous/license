...
/**
* @see \App\Http\Controllers\Core\SidebarMenuController::toggle
 * @see app/Http/Controllers/Core/SidebarMenuController.php:65
 * @route '/admin/sidebar-menus/{sidebarMenu}/toggle'
 */
export const toggle = (args: { sidebarMenu: string | number | { id: string | number } } | [sidebarMenu: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/sidebar-menus/{sidebarMenu}/toggle'
 */
toggle.url = (args: { sidebarMenu: string | number | { id: string | number } } | [sidebarMenu: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { sidebarMenu: args }
    }
 ...
 * @route '/admin/sidebar-menus/{sidebarMenu}/toggle'
 */
toggle.post = (args: { sidebarMenu: string | number | { id: string | number } } | [sidebarMenu: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: toggle.url(args, options),
    method: 'post',
})
...
addChild: Object.assign(addChild, addChild),
}
