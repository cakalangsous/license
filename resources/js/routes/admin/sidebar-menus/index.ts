 ...
 */
export const toggle = (args: { sidebarMenu: number | { id: number } } | [sidebarMenu: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/sidebar-menus/{sidebarMenu}/toggle'
 */
toggle.url = (args: { sidebarMenu: number | { id: number } } | [sidebarMenu: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { sidebarMenu: args }
    }
 ...
 * @route '/admin/sidebar-menus/{sidebarMenu}/toggle'
 */
toggle.post = (args: { sidebarMenu: number | { id: number } } | [sidebarMenu: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: toggle.url(args, options),
    method: 'post',
})
