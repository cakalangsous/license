...
/**
* @see \App\Http\Controllers\Core\RoleController::roles_data
 * @see app/Http/Controllers/Core/RoleController.php:0
 * @route '/admin/roles/data'
 */
export const roles_data = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: roles_data.url(options),
    method: 'get',
})

roles_data.definition = {
    methods: ["get","head"],
 ...
 * @route '/admin/roles/data'
 */
roles_data.url = (options?: RouteQueryOptions) => {
    return roles_data.definition.url + queryParams(options)
}
 ...
 * @route '/admin/roles/data'
 */
roles_data.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: roles_data.url(options),
    method: 'get',
})
/**
 ...
 * @route '/admin/roles/data'
 */
roles_data.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: roles_data.url(options),
    method: 'head',
})
...
const RoleController = { roles_data, index, store, update, destroy }
